...
<p>Klassische Makler verlangen 2 bis 3 % des Verkaufspreises. Bei einem Objekt von CHF 2 Mio. sind das schnell CHF 40'000 bis 60'000. Dabei ist der Aufwand weitgehend derselbe, egal, ob das Objekt CHF 1 Mio. oder CHF 3 Mio. kostet. Ein <strong>Fixpreis Modell</strong> spart diese Differenz vollständig.</p>
    ...
    faqs: [
      {
        ...
        a: "Üblich sind 2 bis 3 % des Verkaufspreises plus MwSt. Sie ist gesetzlich nicht fixiert und damit verhandelbar. Fixpreis Modelle sind eine transparente Alternative.",
      },
      {
