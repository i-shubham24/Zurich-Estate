      ...
      >
        {items.map((loc) => (
          <Link
            ...
            className="group flex h-[220px] w-[85vw] min-w-[280px] max-w-[320px] shrink-0 snap-start flex-col justify-between border border-line bg-white p-6 transition-all duration-300 hover:border-gold hover:shadow-[var(--shadow-luxe)] sm:w-[320px]"
          >
